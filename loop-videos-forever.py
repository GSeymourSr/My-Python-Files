...
def main():
    ...
    shuffle_order = messagebox.askquestion("Play Order",
                                         "Do you want to shuffle the videos?\n"
                                         "Select 'No' to play in order.")

    if shuffle_order == 'yes':
    ...
    # Play all selected videos indefinitely
    current_video = 0
    while True:
